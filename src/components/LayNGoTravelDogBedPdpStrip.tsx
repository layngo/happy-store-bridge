...
export function LayNGoTravelDogBedPdpStrip() {
  ...
  return (
    ...
    >
      ...
      {/* Product pair with paw trail behind (not over) the mats */}
      <div className="relative mt-8 w-full sm:mt-10">
        <div
          className={cn(
            "pointer-events-none absolute inset-x-0 z-0 flex items-center justify-end",
            "top-[100px] bottom-0 px-4 sm:px-8",
          )}
          aria-hidden
        >
          <img
            ...
            height={420}
            className={cn(
              "box-content h-auto w-full max-w-[min(100%,48rem)] object-contain opacity-[0.92]",
              "-my-[100px]",
            )}
            loading="lazy"
            decoding="async"
        ...
        <div className="relative z-10 grid w-full grid-cols-2 gap-0">
          <div className="flex min-h-0 w-full flex-col items-start bg-white pt-[100px]">
            <img
              ...
              className="relative z-10 block h-auto w-[80%] max-w-none object-cover object-left"
              loading="lazy"
              decoding="async"
            />
          </div>
          <div className="flex min-h-0 w-full justify-end bg-white">
            <img
              ...
              className="relative z-10 ml-auto block h-auto w-[80%] max-w-none object-cover object-right"
              loading="lazy"
              decoding="async"
            />
          </div>
      ...
      <div
        className="relative z-10 mx-auto mt-14 flex w-full max-w-[min(100%,90rem)] flex-row flex-nowrap items-center justify-center gap-0.5 overflow-x-hidden px-0.5 pt-12 sm:mt-16 sm:gap-1 sm:px-1 sm:pt-14 md:gap-2 lg:gap-3"
