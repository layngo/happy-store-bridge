...
const STORAGE_KEY_LITE = "lay-n-go-lite-18-callout-layout-v14";
...
/** ~200px up on Lite diagram stage (768px reference height). */
const LITE_HANDLE_CALLOUT_UP_PX = 200;
const LITE_HANDLE_CALLOUT_UP_DY = (LITE_HANDLE_CALLOUT_UP_PX / 768) * 100;
...
const DEFAULT_LAYOUT_LITE: LayoutState = {
  dots: {
    handle: { x: 50, y: 14 - LITE_HANDLE_CALLOUT_UP_DY },
    cord: { x: 50, y: 79 },
    mesh: { ...DEFAULT_LAYOUT_LIFESTYLE.dots.mesh },
    lip: { x: 31 - LITE_LIP_DOT_DX_10PX, y: 49 },
  },
  anchors: {
    handle: { x: 50, y: 4 - LITE_HANDLE_CALLOUT_UP_DY },
