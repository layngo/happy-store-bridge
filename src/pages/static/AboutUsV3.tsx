...
function AboutUsV3Intro() {
  return (
    <header className="py-12 text-center sm:py-14 md:py-16 lg:py-20">
      <p className="mx-auto max-w-4xl font-logo text-[clamp(1.375rem,4vw,2.25rem)] font-semibold leading-snug tracking-tight text-foreground">
        Let&apos;s face it, About Us pages are boring!
        <br />
        Lay-n-Go is fun and saves time!
      </p>
    </header>
  );
}
