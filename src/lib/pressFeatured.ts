...
export const PRESS_FEATURED_ITEMS: readonly PressFeaturedItem[] = [
  ...
  },
  {
    ...
    productName: "",
    imageSrc: "/press/featured-cntraveler-editors-picks.png?v=4",
  ...
  },
  {
    ...
    imageSrc: "/press/featured-women-owned-logo.png?v=2",
  ...
  },
  {
    ...
    imageSrc: "/press/featured-gma-deals-steals-logo.png?v=1",
