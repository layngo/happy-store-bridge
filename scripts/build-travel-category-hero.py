#!/usr/bin/env python3
"""Build lossless Travel & Lifestyle category hero from golden-hour outdoor art."""
...
DEFAULT_SRC = ASSETS / "ChatGPT_Image_Jun_2__2026__10_48_28_PM-48f11e51-1981-47d8-a299-b3a16bf89eef.png"
...
def build(src: Path) -> None:
    ...
    one_path = OUT / "category-hero-travel-lifestyle.png"
    two_path = OUT / "category-hero-travel-lifestyle@2x.png"
    card_path = OUT / "category-travel-lifestyle.png"
